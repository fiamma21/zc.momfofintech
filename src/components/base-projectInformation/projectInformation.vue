<template>
 <div class="projectInformation">
   <ul>
     ...
     <li>
       <p><span>租赁期限</span>{{ Project.leaseTerm}}月</p>
       <p><span>产权年限</span>{{ Project.propertyYears }}年</p>
     </li>
     <li>
       <p><span>产权人</span>{{ Project.propertyOwner}}</p>
       <p><span>房屋类型</span>{{ housingType }}</p>
     </li>
     <li>
       <p><span>土地性质</span>{{ landProperty }}</p>
       <p><span>剩余房龄</span>{{ Project.remainingAge }}年</p>
     </li>
